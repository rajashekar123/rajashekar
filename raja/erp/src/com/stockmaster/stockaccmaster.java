...
//			driver.findElement(By.xpath("html/body/div[17]/div[2]/div/div[4]/div[2]/button[1]")).click();
			java.util.List<WebElement> button=driver.findElements(By.tagName("button"));
...
//			System.out.println(split[0]+"--"+split[1]+"--"+split[2]);
			do 
			{
				java.util.List<WebElement> rows=driver.findElements(By.xpath("//*[@id='tbl_a_stock_categorieslist']/tbody/tr"));
...
//			System.out.println(split.length);
			...
			do 
			{
				java.util.List<WebElement> rows=driver.findElements(By.xpath(".//*[@id='tbl_a_unit_of_measurementlist']/tbody/tr"));
				for (int i = 0; i < rows.size(); i++) 
				{
					java.util.List<WebElement> cols=rows.get(i).findElements(By.tagName("td"));
